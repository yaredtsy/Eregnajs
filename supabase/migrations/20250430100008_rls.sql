-- RLS temporarily commented out. Re-enable by uncommenting below and run `supabase db reset`
-- (or add a migration that enables RLS + policies). See also 20250430110000_disable_rls.sql
-- for databases that already applied the previous version of this file.
